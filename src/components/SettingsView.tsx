...
interface SettingsViewProps {
  ...
  onToggleAlwaysOnTop: (isAlwaysOnTop: boolean) => void;
}

export const SettingsView: FC<SettingsViewProps> = ({ settings, onSettingsChange, notificationPermission, onRequestNotificationPermission, onExport, onImport, theme, setTheme, isAlwaysOnTop, onToggleAlwaysOnTop }) => {
  ...
  return (
    <div className="flex flex-col items-center max-w-xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
      ...
      <div className="w-full space-y-4">
        <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
          <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-2">账户设置(未实现)</h3>
          <p className="text-gray-600 dark:text-gray-300">原神昵称: yuanyou</p>
          <p className="text-gray-600 dark:text-gray-300">uid: 1145141919810</p>
          <button className="mt-4 px-4 py-2 bg-indigo-500 text-white dark:text-gray-800 rounded-md hover:bg-indigo-600 transition">
            修改资料
          </button>
        </div>
        <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
          <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-2">数据管理</h3>
          <div className="flex items-center justify-between">
            <span className="text-gray-600 dark:text-gray-300">备份与恢复:</span>
        ...
        <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
          ...
          <div className="flex items-center justify-between mt-4">
            <span className="text-gray-600 dark:text-gray-300">窗口置顶:</span>
            <label htmlFor="alwaysOnTop" className="flex items-center cursor-pointer">
              <div className="relative">
                ...
                <div className={`dot absolute left-1 top-1 bg-white w-6 h-6 rounded-full transition ${isAlwaysOnTop ? 'transform translate-x-6' : ''}`}></div>
              </div>
            </label>
          </div>
          <div className="flex items-center justify-between mt-4">
